...
<?php require_once '../header.php'; ?>
    ...
    <table class="table1">
        ...
        <tbody class="tbody1">
            ...
            ?>
                <tr class="tr1">
                    <td class="td1"><?php echo htmlspecialchars($news['title']); ?></td>
                    <td class="td2"><?php echo htmlspecialchars($news['content']); ?></td>
                    <td class="td3"><?php echo htmlspecialchars($news['created_at']); ?></td>
                    <!-- <td>
